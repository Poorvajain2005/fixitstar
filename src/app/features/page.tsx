...
const Features = () => {
  const features = [
    {
      icon: <BrainCircuit className="h-7 w-7 text-blue-500" />,
      title: "AI-Powered Civic Intelligence",
      description:
    ...
    {
      icon: <Radar className="h-7 w-7 text-violet-500" />,
      title: "Real-Time Governance Tracking",
      description:
    ...
    {
      icon: <MapPinned className="h-7 w-7 text-emerald-500" />,
    ...
    {
      icon: <BellRing className="h-7 w-7 text-orange-500" />,
    ...
    {
      icon: <BarChart3 className="h-7 w-7 text-indigo-500" />,
  ...
  const metrics = [
    ...
    {
      value: "97%",
      label: "Issue Classification Accuracy",
    },
    {
      value: "10K+",
    ...
    {
      value: "70%",
      label: "Faster Resolution Routing",
    },
  ];
  ...
  return (
    <section className="relative overflow-hidden py-28 bg-background">
      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        >
          <Badge className="mb-6 rounded-full border border-blue-500/20 bg-blue-500/10 px-5 py-2 text-blue-500 hover:bg-blue-500/15 transition-colors">
          ...
          <p className="mt-8 text-xl leading-relaxed text-muted-foreground max-w-3xl mx-auto">
            FixIt combines multimodal AI, geospatial intelligence, and predictive
            analytics to transform fragmented civic reporting into scalable
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-3">
          {features.map((feature, index) => (
            ...
            >
              <Card className="group relative h-full overflow-hidden rounded-[32px] border border-black/5 dark:border-white/10 bg-white/60 dark:bg-zinc-950/40 backdrop-blur-2xl shadow-xl shadow-black/[0.03] transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-primary/10">
                {/* GRADIENT ON HOVER */}
                <div
                ...
                <CardContent className="relative z-10 p-8">
                  {/* ICON HOLDER */}
                  <div className="mb-8 flex h-16 w-16 items-center justify-center rounded-3xl border border-black/5 dark:border-white/10 bg-background/40 backdrop-blur-xl shadow-md">
                    {feature.icon}
                  </div>

                  {/* TITLE */}
                  <div className="mb-4 flex items-start justify-between gap-4">
                    <h3 className="text-2xl font-black tracking-tight leading-snug text-foreground">
                      {feature.title}
                    </h3>
                    <ArrowUpRight className="h-5 w-5 text-muted-foreground flex-shrink-0 transition-transform duration-300 group-hover:-translate-y-1 group-hover:translate-x-1" />
                  </div>
        ...
        <motion.div
          ...
          className="mt-24"
        >
          <div className="relative overflow-hidden rounded-[40px] border border-black/5 dark:border-white/10 bg-white/60 dark:bg-zinc-950/40 backdrop-blur-2xl shadow-2xl shadow-black/[0.03]">
            {/* GLOW */}
        ...
        >
          {[
            ...
            <div
              key={item}
              className="flex items-center gap-2 rounded-full border border-black/5 dark:border-white/10 bg-white/50 dark:bg-zinc-900/50 px-5 py-3 backdrop-blur-xl shadow-sm"
            >
